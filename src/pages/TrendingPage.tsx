        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {breaking.length > 0 && (
            <section>
              <div className="flex items-center gap-3 mb-5">
                ...
                <h2 className="text-2xl font-black text-gray-900 dark:text-white font-['Manrope']">Breaking News</h2>
              </div>
          ...
          <section>
            <div className="flex items-center gap-3 mb-5">
              ...
              <h2 className="text-2xl font-black text-gray-900 dark:text-white font-['Manrope']">Trending Stories</h2>
            </div>
                  ...
                  <div className="flex gap-5 py-5 group">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-2 text-xs text-gray-400">
                        ...
                        <span>·</span>
                        <span className="flex items-center gap-1"><Eye size={10} />{formatViews(post.views)} views</span>
                      </div>
                    </div>
                    <Link to={`/article/${post.slug}`} className="flex-shrink-0 hidden sm:block">
                      <img src={post.featuredImage} alt="" className="w-28 h-20 object-cover rounded-lg" />
                    </Link>
                  </div>
